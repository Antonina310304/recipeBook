...
import { PortalMessageModule } from "../../common/repositories/portal-message/portal-message.module";
...
@Module({
  imports: [AuthModule, UserNotificationSettingModule, UsersModule, PortalMessageModule],
